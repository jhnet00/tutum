            ...
            <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid md:grid-cols-2 gap-8 lg:gap-10 items-center">
                    ...
                    <div className="text-center md:text-left order-2 flex flex-col items-center md:items-start">
                        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-foreground mb-4 tracking-tight leading-tight">
                            중요한 타이밍,<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-indigo-500">절대 놓치지 마세요.</span>
                        </h2>
                        <p className="text-lg text-muted-foreground mb-6 leading-relaxed max-w-md mx-auto md:mx-0">
                        ...
                        <motion.div
                            ...
                            className="mt-4 w-full max-w-[90px] translate-y-[18px] self-center md:max-w-[112px] md:-translate-x-[30px] md:translate-y-[30px] md:self-center"
                        >
                            <Image
